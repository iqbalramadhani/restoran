    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Stock Barang">
            <a class="nav-link" href="<?php echo base_url().'pantry/stock_barang'?>">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        <form class="bootstrap-form-with-validation">
            ...
            <div class="form-group">
                <label class="control-label" for="text-input">Id Kategori</label>
                <input class="form-control" type="text" name="id_kategori" id="password-input">
            </div>
            <div class="form-group">
                <label class="control-label" for="text-input">Nama Makanan</label>
                <input class="form-control" type="text" name="nama_makanan" id="nama_makanan">
            </div>
            <div class="form-group">
                <label class="control-label" for="text-input">Harga</label>
                <input class="form-control" type="tetx" name="harga" id="harga">
            </div>
            
            <div class="form-group">
                <label class="control-label" for="file-input">Gambar</label>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="<?php echo base_url().'pantry'?>">Logout</a>
          </div>
        </div>
      </div>
    </div>
