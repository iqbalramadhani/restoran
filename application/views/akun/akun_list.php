...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $akun->id_pegawai ?></td>
			<td><?php echo $akun->password ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('akun/read/'.$akun->username),'Read'); 
				echo ' | '; 
				echo anchor(site_url('akun/update/'.$akun->username),'Update'); 
				echo ' | '; 
				echo anchor(site_url('akun/delete/'.$akun->username),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
